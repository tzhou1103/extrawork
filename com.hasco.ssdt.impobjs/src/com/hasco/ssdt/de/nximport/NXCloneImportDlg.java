...
public class NXCloneImportDlg extends AbstractAIFDialog{
	...
	iTextField importAssemlyPathField ;
	iTextField ugBaseDirField ;
	JFileChooser importAssemlyPathChooser ;
...
public void initUI()throws TCException,Exception{
		...
		importAssemlyPathField = new iTextField();
		importAssemlyPathField.setPreferredSize(new Dimension(160, 24));
		importAssemlyPathField.setEditable(false);
		...
		importAssemlyPathChooser = new JFileChooser();
	    ...
	    topPanel.add("1.2.center.top.preferred.preferred", importAssemlyPathField);
    ...
    public void addActionListener()throws TCException,Exception{
		...
		confirmButton.addActionListener(new ActionListener() {              
            ...
            public void actionPerformed(ActionEvent e) {
            	...
            	if(importAssemlyPathField.getText().equals("")){
            		...
            		MsgBox.showM("请选择NX安装路径", "提示",
							MessageBox.INFORMATION);
            		return;
            	}else if (CommonUtils.isContainChinese(importAssemlyPathField.getText())){
            		MsgBox.showM("导入装配路径不能包含中文", "提示",
							MessageBox.INFORMATION);
            		return;
            	}
            	
            	File file=new File(importAssemlyPathField.getText().toString());    
            	...
            	NXCloneImport nxClone = new NXCloneImport(importAssemlyPathField.getText().toString(),ugBaseDirField.getText().toString(),defaultServerURL);
		...
		selectExportPathButton.addActionListener(new ActionListener() {              
            ...
            public void actionPerformed(ActionEvent e) {  
            	...
            	importAssemlyPathChooser.setFileSelectionMode(JFileChooser.FILES_ONLY);
                int intRetVal = importAssemlyPathChooser.showOpenDialog(NXCloneImportDlg.this);
            	if( intRetVal == JFileChooser.APPROVE_OPTION){
            		importAssemlyPathField.setText(importAssemlyPathChooser.getSelectedFile().getPath());
                }
