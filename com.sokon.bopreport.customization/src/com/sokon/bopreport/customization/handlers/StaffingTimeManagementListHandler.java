...
//				LinkedHashMap<String, Vector<StaffingTimeManagement>> staffingTimeManagementMap = new LinkedHashMap<String, Vector<StaffingTimeManagement>>();
				...
				// 修改单班定额合并问题，当工位地址前六位相同时，合并单班定额，by tzhou, 2019-01-23
			...
			if (contexts != null && contexts.length > 0) 
			{
				for (AIFComponentContext context : contexts) 
				{
					...
					if (itemRevision instanceof TCComponentMEOPRevision) 
					{
						...
						String processSection = staffingTimeManagement.processSection; // 根据工段分组
						...
						// 增加工位地址前6位的分组，added by tzhou, 2019-01-23
						String subStationAddress = staffingTimeManagement.subStationAddress; // 工位地址前6位
