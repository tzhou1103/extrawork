...
public class NXCloneExportDlg extends AbstractAIFDialog{
	...
	public NXCloneExportDlg(Frame frame, String title){
		...
		try {
			...
			MsgBox.showM(e.getError(),"",MessageBox.ERROR);
			e.printStackTrace();
		}catch (Exception e) {
...
public void initUI()throws TCException,Exception{
		...
		ugMasterCheckBox = new JCheckBox("数模");
		ugPartCheckBox   = new JCheckBox("图纸");
		imageCheckBox    = new JCheckBox("图像");
		wordCheckBox     = new JCheckBox("Word");
		excelCheckBox    = new JCheckBox("Excel");
		pdfCheckBox      = new JCheckBox("PDF");
		rarCheckBox      = new JCheckBox("压缩文件");
	    ...
	    topPanel.add("1.1.left.top.preferred.preferred", new JLabel("选择导出路径:"));
	    topPanel.add("1.2.center.top.preferred.preferred", exportPathField);
    ...
    public void addActionListener()throws TCException,Exception{
		...
		confirmButton.addActionListener(new ActionListener() {              
            ...
            public void actionPerformed(ActionEvent e) {
            	...
            	if(exportPathField.getText().equals("")){
            		MsgBox.showM("请选择导出路径", "提示",
            	...
            	NXCloneExport nxExport = new NXCloneExport(exportPathField.getText().toString(),ugBaseDirField.getText().toString(),selectList,defaultServerURL);
